  ...
  <div class="container">
    <div class="row">
      <div class="col-lg">
        <h5>Quick Bio</h5>
        <p>
          I'm a Chicago based product designer and photographer experienced in web, mobile & print.
        </p>

        <p>I'm not currently accepting freelance work, but you can contact the Sales team at
          <a target="_blank" href="https://earlybird.co">Earlybird</a> if you're interested in
